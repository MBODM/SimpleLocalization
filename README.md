...
2. Add a folder named "Resources" to your project. There is also an overloaded method in the middleware, allowing you to specify the name and path of that folder.
